# encoding: utf-8
class BizCalendar::Public::Piece::HolidaysController < BizCalendar::Public::Piece::BaseController
  def pre_dispatch
    @piece = BizCalendar::Piece::Holiday.find_by_id(Page.current_piece.id)
