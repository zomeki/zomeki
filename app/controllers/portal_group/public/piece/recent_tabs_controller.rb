# encoding: utf-8
class PortalGroup::Public::Piece::RecentTabsController < Sys::Controller::Public::Base
  ...
  def index
    ...
    PortalGroup::Piece::RecentTabXml.find(:all, @piece, :order => :sort_no).each do |tab|
