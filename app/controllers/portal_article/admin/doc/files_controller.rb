class PortalArticle::Admin::Doc::FilesController < Cms::Controller::Admin::Base
  ...
  def pre_dispatch
    ...
    if params[:content]
      @content = PortalArticle::Content::Doc.find_by_id(params[:content])
    end
    return http_error(404) if @content.nil? || @content.model != 'PortalArticle::Doc'
  end
