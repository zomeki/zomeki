...
centos() {
  ...
  yum -y install glibc-devel.i686 libstdc++-devel.i686 sox

  cd /usr/local/src
  rm -rf hts_engine_API-1.07.tar.gz hts_engine_API-1.07
  curl -fsSLO http://downloads.sourceforge.net/hts-engine/hts_engine_API-1.07.tar.gz
  ...
  curl -fsSLO http://downloads.sourceforge.net/open-jtalk/open_jtalk-1.06.tar.gz
  ...
  curl -fsSLO http://downloads.sourceforge.net/open-jtalk/open_jtalk_dic_utf_8-1.06.tar.gz
